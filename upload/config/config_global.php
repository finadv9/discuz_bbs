...
$_config['db']['1']['dbuser'] = 'finadvus_discz34';
$_config['db']['1']['dbpw'] = 'YbuZiNj2.CNA';
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'finadvus_discuzx34';
$_config['db']['1']['tablepre'] = 'discuzx34_';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = 'BatEAC_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'rO02_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = 'a753c7bfeb8642f703f432d7bd4d2293VxqUtP46PcWrKksnac';
