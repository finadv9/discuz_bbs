...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1539407084, '1', './data/template/1_1_common_header_member_activate.tpl.php', './template/default', 'common/header_member_activate')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1539407084, '1', './data/template/1_1_common_header_member_activate.tpl.php', './template/default', 'common/header_member_activate')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1539407084, '1', './data/template/1_1_common_header_member_activate.tpl.php', './template/default', 'common/header_member_activate')
;?>
